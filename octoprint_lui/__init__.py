    ...
    def __init__(self):
        ...
        self.update_info = [
            ...
            },
            {
                ...
                'path': '/Users/pim/OctoPrint-NetworkManager',
                'update': False,
            ...
            },
            {
                ...
                'path': '/Users/pim/OctoPrint-flashArduino',
                'update': False,
    ...
    def initialize(self):
        ...
        if not is_variable_in_dict('update_lui', actions):
            update_lui = {
                "action": "update_lui",
                "name": "Update LUI",
                "command": "cd /Users/pim/OctoPrint-LUI && git pull && /Users/pim/OctoPrint/venv/bin/python setup.py install",
                "confirm": False
            }
        ...
        if not is_variable_in_dict('update_networkmanager', actions):
            update_networkmanager = {
                ...
                "command": "cd /Users/pim/OctoPrint-NetworkManager && git pull && /Users/pim/OctoPrint/venv/bin/python setup.py install",
                "confirm": False
            }
        ...
        if not is_variable_in_dict('update_octoprint', actions):
            update_octoprint = {
                ...
                "command": "cd /Users/pim/OctoPrint && git pull && /Users/pim/OctoPrint/venv/bin/python setup.py install",
                "confirm": False
            }
        ...
        if not is_variable_in_dict('update_flasharduino', actions):
            update_flasharduino = {
                ...
                "command": "cd /Users/pim/OctoPrint-flashArduino && git pull && /Users/pim/OctoPrint/venv/bin/python setup.py install",
                "confirm": False
            }
