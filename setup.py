...
plugin_identifier = "lui"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_lui"
...
# module
plugin_description = "update function"
...
plugin_requires = ["tinydb>=3.2.0","RPi.GPIO","cssmin", "onedrivesdk", "google-api-python-client"]
...
plugin_additional_data = ["gcodes", "printerProfiles", "system_scripts"]
